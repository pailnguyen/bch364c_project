...
tf.app.flags.DEFINE_integer('batch_size', 80,
                            """Number of images to process in a batch.""")  # 128
tf.app.flags.DEFINE_string('data_dir', '/tmp/jkl_data',
                           """Path to the data directory.""")

# Global constants describing the data set.
IMAGE_SIZE = jkl_input.IMAGE_SIZE
NUM_CLASSES = jkl_input.NUM_CLASSES
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = jkl_input.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = jkl_input.NUM_EXAMPLES_PER_EPOCH_FOR_EVAL
...
def distorted_inputs():
  ...
  data_dir = os.path.join(FLAGS.data_dir, 'jkl_data')
  images, labels = jkl_input.distorted_inputs(data_dir=data_dir,
...
def inputs(eval_data):
  ...
  if not FLAGS.data_dir:
    raise ValueError('Please supply a data_dir')
  data_dir = os.path.join(FLAGS.data_dir, 'jkl_data')
  images, labels = jkl_input.inputs(eval_data=eval_data,
                                        data_dir=data_dir,
                                        batch_size=FLAGS.batch_size)
  return images, labels
